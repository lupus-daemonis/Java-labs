...
public class Product {
    ...
    public String fileWrite() {
        return title + "\n"+
                productType.fileWrite() +
                unit.fileWrite() +
                priceForUnit + "\n";
    }

    public void fileRead(String title, String productType, String unit, String priceForUnit){
        this.title = title;
        this.productType.fileRead(productType);
        this.unit.fileRead(unit);
        this.priceForUnit = Double.parseDouble(priceForUnit);
    }
}
