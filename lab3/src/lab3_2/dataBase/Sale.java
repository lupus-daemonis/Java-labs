...
public class Sale {
    ...
    public Sale(Product product, Buyer buyer, int amountOfProduct, Date dateOfSale){
        this.product = product;
        this.buyer = buyer;
    ...
    public void scan(Scanner scanner){
        ...
        while(true){
            try{
                System.out.println("Enter date of sale (yyyy-MM-dd HH:mm:ss): ");
                scanner.nextLine();
                dateOfSale = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(scanner.nextLine());
            }
